...
bool DabbleInputs::getSlideSwitchStatus(uint8_t SS,uint8_t dir)
{
	...
	// Si ninguna condicion anterior se cumple, devolver false
	return false;
}
...
bool DabbleInputs::getTactileSwitchStatus(uint8_t TS)
{
	...
	// Si TS no es 1 ni 2, devolver false
	return false;
}
...
int DabbleInputs::getPotValue(uint8_t Pot)
{
	...
	// Si Pot no es 1 ni 2, devolver 0 (o considerar -1 para indicar error)
	return 0;
}
